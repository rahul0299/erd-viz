...
const PreviewModal = (props) => {
  ...
  const storeByFromToKey = (linkDataArray) => {
    const map = {};
  ...
  const transformLinkDataArray = (linkDataArray) => {
    const storedData = storeByFromToKey(linkDataArray);
    ...
    for (const link of linkDataArray) {
      if (!link.text) {
        ...
        transformedLinks.push(storedData[key]);
      } else {
        transformedLinks.push(link);
      }
    }
  ...
  useEffect(() => {
    if (props.open) {
      ...
      //   data.linkDataArray = transformLinkDataArray(data.linkDataArray)
